...
const Header = () => {
  return (
    <div className="headerShadow px-28 md:px-4">
        ...
        <div className="navbar bg-base-100 px-0">
          ...
          <div className="navbar-end w-[75%] flex lg:hidden">
            <div className="dropdown dropdown-left">
              ...
              <ul
                tabIndex={0}
                className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-48 text-white"
              >
                <li className="">
                ...
                <li className="">
                  <NavLink to="/history" className="btn-theme">
                    <div className="">
                ...
                <li className="">
                  <NavLink to="/missed-exams" className="btn-theme">
                    <div className="">
                ...
                <li className="">
                  <NavLink to="/login" className="btn-theme">
                    Logout
                    <div className="">
          ...
          <div className="navbar-end w-[75%] hidden lg:flex">
            <ul className="menu menu-horizontal px-1 text-white font-bold text-sm">
              <li className="m-2 text-center w-[10rem] h-12">
                <NavLink to="/" className="relative btn-theme btn-block navBtn">
